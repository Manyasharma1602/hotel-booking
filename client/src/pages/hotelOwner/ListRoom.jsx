                    ...
                    <tbody className='text-sm'>
                        {
                            rooms.map((item, index)=>(
                                <tr key={index}>
                                   ...
                                   <td className='py-3 px-4 text-gray-700 border-t border-grey-300'>
                                     {item.roomType}
                                   </td>

                                   <td className='py-3 px-4 text-gray-700 border-t border-grey-300 max-sm:hidden'>
                                     {item.amenities.join(', ')}
                                   </td>
                                   ...
                                   <td className='py-3 px-4 border-t border-grey-300 text-sm text-red-500 text-center'>
