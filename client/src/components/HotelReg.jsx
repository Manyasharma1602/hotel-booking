...
const HotelReg = () => {
         ...
         try {
           // event.preventDefault();
            ...
            if(data.success){
               ...
               if(data.message === "Hotel Already Registered"){
                  setShowHotelReg(false);
               }
            }
         } catch (error) {
            ...
            if(errorMessage === "Hotel Already Registered"){
               setShowHotelReg(false);
            }
         }
      }
    ...
    return(
        <div onClick={()=> setShowHotelReg(false)} className='fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70'>
           <form onSubmit={(e)=> e.preventDefault()} onClick={(e)=> e.stopPropagation()} className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
            ...
            <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                ...
                <div className="w-full mt-4">
                   ...
                   <input onChange={(e)=>setAddress(e.target.value)} value={address} id='address' type="address" placeholder="Type here" className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light" required />
                </div>
                ...
                <button type="button" onClick={onSubmitHandler} className='bg-indigo-500 hover:bg-indigo-600 transition-all text-white mr-auto px-6 py-2 rounded cursor-pointer mt-6'>Register</button>
